...
func (_mock *MockPublisher) Publish(topic string, message []byte) error {
	ret := _mock.Called(topic, message)
...
func (_c *MockPublisher_Publish_Call) Run(run func(topic string, message []byte)) *MockPublisher_Publish_Call {
...
func (_c *MockPublisher_Publish_Call) RunAndReturn(run func(topic string, message []byte) error) *MockPublisher_Publish_Call {
	_c.Call.Return(run)
	return _c
}
